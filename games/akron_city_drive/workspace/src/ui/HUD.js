          ...
          <div class="unity-gauge">
            <div class="unity-gauge-face">
              ...
              <div class="unity-gauge-readout">
                ...
                <span class="unity-gauge-kmh">MPH</span>
              </div>
...
export function updateHud() {
  if (state.route === "game") {
    ensureGameplayHud();
    const speedMph = Math.max(0, Math.round((state.game.speed || 0) * 0.621371));
    ...
    gameplayHud.speedValue.textContent = String(speedMph);
  ...
  if (state.route === "game") {
    ...
    add("Speed", `${((state.game.speed || 0) * 0.621371).toFixed(0)} mph`);
