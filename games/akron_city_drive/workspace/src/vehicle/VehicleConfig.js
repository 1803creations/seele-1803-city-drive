...
const TOP_SPEED_80_MPH_KMH = 128.75;
...
const DEFAULT_DYNAMICS = {
  engineTorque: 980,
  maxSpeedKmh: TOP_SPEED_80_MPH_KMH,
  brakeForce: 26,
  handbrakeForce: 42,
  steerAngle: 0.78,
  traction: 1.25,
    ...
    return {
      ...
      raw: {
        ...
        dynamics: {
          ...
          maxSpeedKmh: Math.min(TOP_SPEED_80_MPH_KMH, vehicle.dynamics?.maxSpeedKmh ?? TOP_SPEED_80_MPH_KMH),
